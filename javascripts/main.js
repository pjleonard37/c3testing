...
(function() {
  ...
  var chart = c3.generate({
      ...
      data: {
        x: 'x',
        columns: [
          ['x', '2013-01-01', '2013-04-01', '2013-07-01', '2013-10-01', '2014-01-01', '2014-04-01', '2014-07-01', '2014-10-01'],
          ['New York', 1000232, 1050232, 1100232, 1300232, 1000232, 1050232, 1100232, 1300232],
          ['Boston', 1800232, 1200232, 1700232, 1100232, 1000232, 1050232, 1100232, 1300232],
          ['Philadelphia', 1330232, 1870232, 2500232, 1065232, 1000232, 1050232, 1100232, 1300232]
        ]
      },
      axis: {
        x: {
